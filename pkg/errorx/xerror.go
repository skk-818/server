...
var (
	...
	ErrInvalidToken          = New(401, "token 无效")
	ErrTokenExpired          = New(401, "token 已过期")
	ErrTokenInvalid          = New(401, "token 无效")
	ErrTokenMalformed        = New(401, "token 格式错误")
	ErrTokenNotValidYet      = New(401, "token 尚未生效")
